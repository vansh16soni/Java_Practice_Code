...
public class DateTimeFormatter_E {
...
//
//        String myDate = ldt.format(df); // Creating date string using date and format
...
//        Solid_Rectangle_Pattern for formatting and parsing :
